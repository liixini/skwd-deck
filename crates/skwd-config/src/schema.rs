...
const STATIC_SPECS: &[SettingSpec] = &[
    ...
    SettingSpec::boolean(crate::keys::filter_bar::SHOW_ORIENT, true),
    SettingSpec::boolean(crate::keys::filter_bar::SHOW_DOWNLOAD, true),
    SettingSpec::boolean(crate::keys::filter_bar::SHOW_PLAYLISTS, true),
    ...
    SettingSpec::boolean(crate::keys::selector::HAND_REVEAL_FILL, true),
    ...
    SettingSpec::boolean(crate::keys::niri::FULL_WIDTH_PAUSE, false),
    SettingSpec::text(crate::keys::paper::WALLPAPER_LAYER, "bottom"),
    ...
    SettingSpec::text(crate::keys::we_render::CLAMP, "clamp"),
    ...
    SettingSpec::text(crate::keys::keybind::SORT_PREV, ""),
    SettingSpec::text(crate::keys::keybind::SOURCE_BING, ""),
    SettingSpec::text(crate::keys::keybind::SOURCE_PEXELS, ""),
    SettingSpec::text(crate::keys::keybind::SOURCE_STEAM, ""),
    SettingSpec::text(crate::keys::keybind::SOURCE_UNSPLASH, ""),
    SettingSpec::text(crate::keys::keybind::SOURCE_WALLHAVEN, ""),
    SettingSpec::text(crate::keys::keybind::SOURCE_YOUTUBE, ""),
    SettingSpec::text(crate::keys::keybind::TYPE_NEXT, ""),
    SettingSpec::text(crate::keys::keybind::TYPE_PREV, ""),
    ...
    SettingSpec::number(crate::keys::selector::SLICE_SPACING, 0.0),
    ...
    SettingSpec::boolean(crate::keys::playback::PROCESS_ENABLED, false),
    SettingSpec::text(crate::keys::playback::PROCESSES, ""),
    SettingSpec::boolean(crate::keys::playback::FULLSCREEN, false),
    SettingSpec::boolean(crate::keys::playback::MAXIMIZED, false),
    SettingSpec::text(crate::keys::playback::FULLSCREEN_SCOPE, "all"),
    SettingSpec::number(crate::keys::playback::RESUME_DELAY, 1.0),
    SettingSpec::boolean(crate::keys::playback::MUTE_ON_OTHER_AUDIO, false),
