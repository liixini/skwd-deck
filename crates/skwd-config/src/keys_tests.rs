...
fn wire_strings_pinned() {
    ...
    assert_eq!(keys::keybind::SORT_PREV, "keys.sortPrev");
    assert_eq!(keys::keybind::SOURCE_BING, "keys.sourceBing");
    assert_eq!(keys::keybind::SOURCE_PEXELS, "keys.sourcePexels");
    assert_eq!(keys::keybind::SOURCE_STEAM, "keys.sourceSteam");
    assert_eq!(keys::keybind::SOURCE_UNSPLASH, "keys.sourceUnsplash");
    assert_eq!(keys::keybind::SOURCE_WALLHAVEN, "keys.sourceWallhaven");
    assert_eq!(keys::keybind::SOURCE_YOUTUBE, "keys.sourceYoutube");
    assert_eq!(keys::keybind::TYPE_NEXT, "keys.typeNext");
    assert_eq!(keys::keybind::TYPE_PREV, "keys.typePrev");
